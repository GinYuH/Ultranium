...
public class NetherBeacon : ModItem
{
	...
	public override bool CanUseItem(Player player)
	{
		...
		{
			return !NPC.AnyNPCs(((ModItem)this).mod.NPCType("Ignodium"));
		}
		return false;
	}
	...
	{
		NPC.NewNPC((int)player.Center.X, (int)player.Center.Y - 150, ((ModItem)this).mod.NPCType("Ignodium"), 0, 0f, 0f, 0f, 0f, 255);
