...
public class HellScepter : ModItem
{
	...
	{
		// ((ModItem)this).DisplayName.SetDefault("Igneous Scepter");
		// ((ModItem)this).Tooltip.SetDefault("Summons a miniature ignodium to fight with you\nOnly one can be summoned at once\nDoes not take up any minion slots");
	}
	...
	public override void SetDefaults()
	{
		...
		((ModItem)this).Item.shoot = ((ModItem)this).Mod.Find<ModProjectile>("Ignodium").Type;
		((ModItem)this).Item.shootSpeed = 10f;
		((ModItem)this).Item.buffType = ((ModItem)this).Mod.Find<ModBuff>("IgnodiumBuff").Type;
	...
	{
		if (player.ownedProjectileCounts[((ModItem)this).Mod.Find<ModProjectile>("Ignodium").Type] > 0)
		{
			return false;
		}
		return true;
