...
public class HellScepter : ModItem
{
	...
	public override void SetDefaults()
	{
		...
		((ModItem)this).item.shoot = ((ModItem)this).mod.ProjectileType("Ignodium");
		((ModItem)this).item.shootSpeed = 10f;
		((ModItem)this).item.buffType = ((ModItem)this).mod.BuffType("IgnodiumBuff");
	...
	{
		if (player.ownedProjectileCounts[((ModItem)this).mod.ProjectileType("Ignodium")] > 0)
		{
			return false;
		}
		return true;
