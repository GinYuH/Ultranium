...
public class CosmicBlade : ModItem
{
	...
	public override void SetDefaults()
	{
		...
		((ModItem)this).item.shoot = ((ModItem)this).mod.ProjectileType("CosmicSwordStar");
	...
	public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
	{
		...
		if (Use >= 30)
		{
			...
			for (int j = 0; j < num10; j++)
			{
				...
				Projectile.NewProjectile(vector2.X, vector2.Y, num17, num18, ((ModItem)this).mod.ProjectileType("GiantSwordStar"), damage, knockBack, Main.myPlayer, 0f, (float)Main.rand.Next(5));
			}
			Use = 0;
		}
		return false;
