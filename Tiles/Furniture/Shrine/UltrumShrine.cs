...
public class UltrumShrine : ModTile
{
	public override void SetStaticDefaults()
	{
		...
		((ModTile)this).AddMapEntry(new Color(70, 57, 50), (LocalizedText)null);
	}

	public override void KillMultiTile(int i, int j, int frameX, int frameY)
	{
		Item.NewItem(null, i * 16, j * 16, 32, 16, ((ModTile)this).Mod.Find<ModItem>("UltrumShrineItem").Type, 1, false, 0, false, false);
	}
}
