...
public class ShrineChest : ModTile
{
	public override void SetDefaults()
	{
		...
		base.chestDrop = ((ModTile)this).mod.ItemType("ShrineChestItem");
		base.chest = "Shrine Chest";
	}
	...
	public override void MouseOver(int i, int j)
	{
		...
		{
			localPlayer.showItemIconText = ((Main.chest[num3].name.Length > 0) ? Main.chest[num3].name : "Shrine Chest");
			if (localPlayer.showItemIconText == "Shrine Chest")
			{
				localPlayer.showItemIcon2 = ((ModTile)this).mod.ItemType("ShrineChestItem");
