...
public class ShadowTableItem : ModItem
{
	public override void SetStaticDefaults()
	{
		// ((ModItem)this).DisplayName.SetDefault("Eldritch Table");
	}
	...
	public override void SetDefaults()
	{
		...
		((ModItem)this).Item.createTile = ((ModItem)this).Mod.Find<ModTile>("ShadowTable").Type;
	}
