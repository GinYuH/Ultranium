...
public class SquidTrophyItem : ModItem
{
	public static int _type;

	public override void SetStaticDefaults()
	{
		// ((ModItem)this).DisplayName.SetDefault("Zephyr Squid Trophy");
	}
	...
	public override void SetDefaults()
	{
		...
		((ModItem)this).Item.createTile = ((ModItem)this).Mod.Find<ModTile>("SquidTrophy").Type;
