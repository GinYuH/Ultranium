...
public class GlobalTiles : GlobalTile
{
	...
	{
		if (type == 70 && Framing.GetTileSafely(i, j - 1).TileType == 0 && Framing.GetTileSafely(i, j - 2).TileType == 0 && Main.rand.Next(200) == 0)
		{
		...
		if (type == 2 && Framing.GetTileSafely(i, j - 1).TileType == 0 && Framing.GetTileSafely(i, j - 2).TileType == 0 && Main.rand.Next(50) == 0)
		{
