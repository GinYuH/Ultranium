...
public class AuroraOreItem : ModItem
{
	...
	{
		// ((ModItem)this).DisplayName.SetDefault("Aurora Crystal Shard");
		// ((ModItem)this).Tooltip.SetDefault("It glows with a neon energy");
	}
	...
	public override void SetDefaults()
	{
		...
		((ModItem)this).Item.createTile = ((ModItem)this).Mod.Find<ModTile>("AuroraOre").Type;
