...
public class ShadowMusicBoxTile : ModTile
{
	...
	{
		Item.NewItem(i * 16, j * 16, 16, 48, ((ModTile)this).mod.ItemType("ShadowMusicBox"), 1, false, 0, false, false);
	}
	...
	public override void MouseOver(int i, int j)
	{
		...
		localPlayer.showItemIcon2 = ((ModTile)this).mod.ItemType("ShadowMusicBox");
	}
}
