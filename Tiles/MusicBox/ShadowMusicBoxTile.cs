...
public class ShadowMusicBoxTile : ModTile
{
	...
	{
		Item.NewItem(null, i * 16, j * 16, 16, 48, ((ModTile)this).Mod.Find<ModItem>("ShadowMusicBox").Type, 1, false, 0, false, false);
	}
	...
	public override void MouseOver(int i, int j)
	{
		...
		localPlayer.cursorItemIconID = ((ModTile)this).Mod.Find<ModItem>("ShadowMusicBox").Type;
	}
}
