...
public class EtherealMusicBox : ModItem
{
	public override void SetStaticDefaults()
	{
		// ((ModItem)this).DisplayName.SetDefault("Music Box (Xenanis)");
	...
	public override void SetDefaults()
	{
		...
		((ModItem)this).Item.createTile = ((ModItem)this).Mod.Find<ModTile>("EtherealMusicBoxTile").Type;
