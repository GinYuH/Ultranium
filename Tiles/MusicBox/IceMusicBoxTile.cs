...
public class IceMusicBoxTile : ModTile
{
	...
	{
		Item.NewItem(null, i * 16, j * 16, 16, 48, Mod.Find<ModItem>("IceMusicBox").Type, 1, false, 0, false, false);
	}
	...
	public override void MouseOver(int i, int j)
	{
		...
		localPlayer.cursorItemIconID = Mod.Find<ModItem>("IceMusicBox").Type;
	}
}
