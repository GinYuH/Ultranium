...
public class AbyssEelBanner : ModItem
{
	...
	{
		// ((ModItem)this).DisplayName.SetDefault("Abyssal Eel Banner");
		// ((ModItem)this).Tooltip.SetDefault("Nearby players get a bonus against: Abyssal Eel");
	}
	...
	public override void SetDefaults()
	{
		...
		((ModItem)this).Item.placeStyle = 9;
	}
}
