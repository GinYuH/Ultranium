...
public class ShadeBatBanner : ModItem
{
	public override void SetStaticDefaults()
	{
		((ModItem)this).DisplayName.SetDefault("Shade Bat Banner");
		((ModItem)this).Tooltip.SetDefault("Nearby players get a bonus against: Depth Bat");
	}
