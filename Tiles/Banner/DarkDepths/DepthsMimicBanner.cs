...
public class DepthsMimicBanner : ModItem
{
	public override void SetStaticDefaults()
	{
		// ((ModItem)this).DisplayName.SetDefault("Depths Mimic Banner");
		// ((ModItem)this).Tooltip.SetDefault("Nearby players get a bonus against: Depths Mimic");
	}
	...
	public override void SetDefaults()
	{
		...
		((ModItem)this).Item.placeStyle = 5;
	}
}
