...
public class AbyssSharkBanner : ModItem
{
	public override void SetStaticDefaults()
	{
		((ModItem)this).DisplayName.SetDefault("Abyssal Goblin Shark Banner");
		((ModItem)this).Tooltip.SetDefault("Nearby players get a bonus against: Abyssal Goblin Shark");
	}
	...
	public override void SetDefaults()
	{
		...
		((ModItem)this).item.placeStyle = 8;
	}
}
