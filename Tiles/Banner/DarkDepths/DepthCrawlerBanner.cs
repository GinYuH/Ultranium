...
public class DepthCrawlerBanner : ModItem
{
	public override void SetStaticDefaults()
	{
		// ((ModItem)this).DisplayName.SetDefault("Depth Crawler Banner");
		// ((ModItem)this).Tooltip.SetDefault("Nearby players get a bonus against: Depth Crawler");
	}
