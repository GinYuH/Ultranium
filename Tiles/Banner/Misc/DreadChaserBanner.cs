...
public class DreadChaserBanner : ModItem
{
	public override void SetStaticDefaults()
	{
		// ((ModItem)this).DisplayName.SetDefault("Dread Chaser Banner");
		// ((ModItem)this).Tooltip.SetDefault("Nearby players get a bonus against: Dread Chaser");
	}
