...
public class AbyssBruteBanner : ModItem
{
	public override void SetStaticDefaults()
	{
		((ModItem)this).DisplayName.SetDefault("Abyssal Brute Banner");
		((ModItem)this).Tooltip.SetDefault("Nearby players get a bonus against: Abyssal Brute");
	}
