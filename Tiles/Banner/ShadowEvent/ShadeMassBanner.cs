...
public class ShadeMassBanner : ModItem
{
	public override void SetStaticDefaults()
	{
		((ModItem)this).DisplayName.SetDefault("Shade Mass Banner");
		((ModItem)this).Tooltip.SetDefault("Nearby players get a bonus against: Shade Mass");
	}
