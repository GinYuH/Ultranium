...
public class IceBall : ModProjectile
{
	...
	public override void OnKill(int timeLeft)
	{
		for (int i = 0; i < 6; i++)
		{
			...
			vector.Normalize();
			vector *= 10f;
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vector.X, vector.Y, ProjectileID.Blizzard, 70, 1f, Main.myPlayer, 0f, 0f);
		}
	}
}
