...
public class Pumpkibomb : ModProjectile
{
	...
	public override void OnKill(int timeLeft)
	{
		...
		int num3 = Gore.NewGore(Projectile.GetSource_FromThis(), new Vector2(Projectile.position.X, Projectile.position.Y), default(Vector2), Main.rand.Next(61, 64));
		...
		num3 = Gore.NewGore(Projectile.GetSource_FromThis(), new Vector2(Projectile.position.X, Projectile.position.Y), default(Vector2), Main.rand.Next(61, 64));
		Main.gore[num3].velocity *= 0.4f;
