...
public class EldritchPumpkibomb : ModProjectile
{
	...
	public override void OnKill(int timeLeft)
	{
		...
		int num6 = Gore.NewGore(Projectile.GetSource_FromThis(), new Vector2(Projectile.position.X, Projectile.position.Y), default(Vector2), Main.rand.Next(61, 64));
		...
		num6 = Gore.NewGore(Projectile.GetSource_FromThis(), new Vector2(Projectile.position.X, Projectile.position.Y), default(Vector2), Main.rand.Next(61, 64));
		Main.gore[num6].velocity *= 0.4f;
