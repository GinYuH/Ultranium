...
public class Inferno : ModProjectile
{
	...
	public override void AI()
	{
		...
		if (((ModProjectile)this).Projectile.frameCounter >= 130)
		{
			...
			int num2 = Projectile.NewProjectile(null, ((ModProjectile)this).Projectile.Center.X, ((ModProjectile)this).Projectile.Center.Y, vector.X, vector.Y, 15, ((ModProjectile)this).Projectile.damage, (float)((ModProjectile)this).Projectile.owner, 0, 0f, 0f);
