...
public class DripProjectile : ModProjectile
{
	...
	public override void AI()
	{
		...
		if (((ModProjectile)this).Projectile.frameCounter >= 140)
		{
			...
			int num2 = Projectile.NewProjectile(null, ((ModProjectile)this).Projectile.Center.X, ((ModProjectile)this).Projectile.Center.Y, vector.X, vector.Y, 27, ((ModProjectile)this).Projectile.damage, (float)((ModProjectile)this).Projectile.owner, 0, 0f, 0f);
