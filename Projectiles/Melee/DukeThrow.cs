...
public class DukeThrow : ModProjectile
{
	...
	public override void AI()
	{
		...
		if (Projectile.frameCounter >= 30)
		{
			...
			int num2 = Projectile.NewProjectile(null, Projectile.Center.X, Projectile.Center.Y, vector.X, vector.Y, Mod.Find<ModProjectile>("MiniTyphoon").Type, Projectile.damage, (float)Projectile.owner, 0, 0f, 0f);
