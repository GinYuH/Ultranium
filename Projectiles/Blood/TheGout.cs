...
public class TheGout : ModProjectile
{
	...
	public override void AI()
	{
		...
		if (Projectile.frameCounter >= 150)
		{
			...
			int num2 = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vector.X, vector.Y, Mod.Find<ModProjectile>("BloodSwirl").Type, Projectile.damage, (float)Projectile.owner, 0, 0f, 0f);
