...
public class Ignodium : ModProjectile
{
	...
	{
		bool num = ((ModProjectile)this).projectile.type == ((ModProjectile)this).mod.ProjectileType("Ignodium");
		...
		if (Main.myPlayer == ((ModProjectile)this).projectile.owner)
		{
			...
			vector4.Normalize();
			vector4 *= 8.5f;
			int num9 = Projectile.NewProjectile(((ModProjectile)this).projectile.Center.X, ((ModProjectile)this).projectile.Center.Y, vector4.X, vector4.Y, ((ModProjectile)this).mod.ProjectileType("HellBeam"), ((ModProjectile)this).projectile.damage, ((ModProjectile)this).projectile.knockBack, Main.myPlayer, 0f, 0f);
