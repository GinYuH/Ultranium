...
public class FlamingBulletBlastBig : ModProjectile
{
	public override string Texture => "Ultranium/Projectiles/Guardians/Hell/FlamingBulletBlast";
	...
	{
		((ModProjectile)this).projectile.scale = 1.8f;
