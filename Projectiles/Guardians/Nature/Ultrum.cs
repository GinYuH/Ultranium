...
public class Ultrum : ModProjectile
{
	...
	public override bool PreDraw(ref Color lightColor)
	{
		...
		for (int i = 0; i < Projectile.oldPos.Length; i++)
		{
			...
			sb.Draw(texture2D, position, value, color, Projectile.rotation, vector, Projectile.scale, effects, 0f);
		}
		return true;
	}
	...
	{
		bool num = Projectile.type == Mod.Find<ModProjectile>("Ultrum").Type;
		...
		if (Main.myPlayer == Projectile.owner)
		{
			...
			vector4.Normalize();
			vector4 *= 8.5f;
			int num9 = Projectile.NewProjectile(null, Projectile.Center.X, Projectile.Center.Y, vector4.X, vector4.Y, Mod.Find<ModProjectile>("NatureBlast").Type, Projectile.damage, Projectile.knockBack, Main.myPlayer, 0f, 0f);
