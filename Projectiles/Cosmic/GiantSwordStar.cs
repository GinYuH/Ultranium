...
public class GiantSwordStar : ModProjectile
{
	...
	public override void Kill(int timeLeft)
	{
		...
		for (int j = 0; j < 8; j++)
		{
			...
			vector.Normalize();
			vector *= 10f;
			Projectile.NewProjectile(((ModProjectile)this).projectile.Center.X, ((ModProjectile)this).projectile.Center.Y, vector.X, vector.Y, ((ModProjectile)this).mod.ProjectileType("CosmicSwordStar"), ((ModProjectile)this).projectile.damage, 1f, Main.myPlayer, 0f, 0f);
		}
	}
}
