...
public class Protostar : ModProjectile
{
	...
	public override void Kill(int timeLeft)
	{
		...
		for (int j = 0; j < 4; j++)
		{
			...
			vector.Normalize();
			vector *= 10f;
			Projectile.NewProjectile(((ModProjectile)this).projectile.Center.X, ((ModProjectile)this).projectile.Center.Y, vector.X, vector.Y, ((ModProjectile)this).mod.ProjectileType("ProtostarBolt"), ((ModProjectile)this).projectile.damage, 1f, Main.myPlayer, 0f, 0f);
		}
	}
}
