...
public class DreadSpear : ModProjectile
{
	...
	public override void AI()
	{
		...
		if (timer == 0)
		{
			...
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity, Mod.Find<ModProjectile>("DreadSickle").Type, (int)((float)Projectile.damage * 1.5f), Projectile.knockBack, Projectile.owner, 0f, 0f);
			timer = 20;
		}
	}
}
