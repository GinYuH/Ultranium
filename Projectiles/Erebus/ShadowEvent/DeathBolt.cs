...
public class DeathBolt : ModProjectile
{
	...
	public override void AI()
	{
		if (((ModProjectile)this).Projectile.ai[0] == 0f)
		{
			...
			{
				int num2 = 8;
				Projectile.NewProjectile(null, ((ModProjectile)this).Projectile.Center.X, ((ModProjectile)this).Projectile.Center.Y, 0f, 0f, ((ModProjectile)this).Mod.Find<ModProjectile>("DeathBoltSwirl").Type, ((ModProjectile)this).Projectile.damage, ((ModProjectile)this).Projectile.knockBack, ((ModProjectile)this).Projectile.owner, (float)(i * num2), (float)((ModProjectile)this).Projectile.whoAmI);
			}
