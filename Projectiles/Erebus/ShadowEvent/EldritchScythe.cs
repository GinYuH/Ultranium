...
public class EldritchScythe : ModProjectile
{
	...
	public override void OnKill(int timeLeft)
	{
		...
		for (int i = 0; i < 5; i++)
		{
			...
			vector.Normalize();
			vector *= 6f;
			Projectile.NewProjectile(null, ((ModProjectile)this).Projectile.Center.X, ((ModProjectile)this).Projectile.Center.Y, vector.X, vector.Y, ((ModProjectile)this).Mod.Find<ModProjectile>("ShadeTentacle").Type, 200, 1f, Main.myPlayer, 0f, 0f);
		}
	}
}
