...
public class DemonMinion : ModProjectile
{
	...
	public override void AI()
	{
		...
		((ModProjectile)this).mod.ProjectileType("DemonMinion");
		...
		obj.AddBuff(((ModProjectile)this).mod.BuffType("DemonBuff"), 3600, fromNetPvP: true);
		if (obj.dead)
		{
		...
		for (int i = 0; i < 200; i++)
		{
			...
			int num3 = ((ModProjectile)this).mod.ProjectileType("DemonScythe");
			float num4 = 24f;
