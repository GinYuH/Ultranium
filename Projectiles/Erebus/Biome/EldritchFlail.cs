...
public class EldritchFlail : ModProjectile
{
	...
	{
		// ((ModProjectile)this).DisplayName.SetDefault("Azathoth");
	}
	...
	public override void AI()
	{
		...
		{
			((ModProjectile)this).Projectile.velocity += 48f * spinningpoint;
		}
		else
		{
		...
		if (((ModProjectile)this).Projectile.alpha == 0)
		{
			for (int i = 0; i < 2; i++)
			{
				Dust obj = Main.dust[Dust.NewDust(((ModProjectile)this).Projectile.position + ((ModProjectile)this).Projectile.velocity * 2f, ((ModProjectile)this).Projectile.width, ((ModProjectile)this).Projectile.height, 89, 0f, 0f, 100, default(Color), 2f)];
				obj.noGravity = true;
				obj.velocity *= 2f;
