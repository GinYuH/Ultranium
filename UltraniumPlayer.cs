...
public class UltraniumPlayer : ModPlayer
{
	...
	public override void OnHitNPCWithProj(Projectile proj, NPC target, NPC.HitInfo hit, int damageDone)/* tModPorter If you don't need the Projectile, consider using OnHitNPC instead */
	{
		...
		{
			target.AddBuff(((ModPlayer)this).Mod.Find<ModBuff>("DreadDebuff").Type, 180);
		}
	...
	{
		if (((ModPlayer)this).Player.FindBuffIndex(((ModPlayer)this).Mod.Find<ModBuff>("DarkDebuff").Type) >= 0)
		{
	...
	public override void PreUpdate()
	{
		...
		if (Main.tile[num, num2].WallType == ((ModPlayer)this).Mod.Find<ModWall>("DarkStoneWall").Type || Main.tile[num, num2].WallType == ((ModPlayer)this).Mod.Find<ModWall>("PurpleDarkstoneWall").Type)
		{
			ZoneDepth = true;
		}
		else
