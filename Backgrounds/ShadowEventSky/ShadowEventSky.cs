...
public class ShadowEventSky : CustomSky
{
	...
	{
		SkyTexture = ModContent.GetTexture("Ultranium/Backgrounds/ShadowEventSky/NightmareSky");
		Rift = ModContent.GetTexture("Ultranium/Backgrounds/ShadowEventSky/NightmareRift");
	}
