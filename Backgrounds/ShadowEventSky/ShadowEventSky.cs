...
public class ShadowEventSky : CustomSky
{
	...
	{
		SkyTexture = ModContent.Request<Texture2D>("Ultranium/Backgrounds/ShadowEventSky/NightmareSky");
		Rift = ModContent.Request<Texture2D>("Ultranium/Backgrounds/ShadowEventSky/NightmareRift");
	}
