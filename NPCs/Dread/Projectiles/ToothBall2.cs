...
public class ToothBall2 : ModProjectile
{
	private int bounceInt = 3;

	public override string Texture => "Ultranium/NPCs/Dread/Projectiles/ToothBall";
	...
	public override void OnKill(int timeLeft)
	{
		for (int i = 0; i < 9; i++)
		{
			...
			vector.Normalize();
			vector *= 6f;
			Projectile.NewProjectile(null, ((ModProjectile)this).Projectile.Center.X, ((ModProjectile)this).Projectile.Center.Y, vector.X, vector.Y, ((ModProjectile)this).Mod.Find<ModProjectile>("DreadTooth").Type, 30, 1f, Main.myPlayer, 0f, 0f);
		}
	}
