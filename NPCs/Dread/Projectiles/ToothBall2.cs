...
public class ToothBall2 : ModProjectile
{
	...
	public override void OnKill(int timeLeft)
	{
		for (int i = 0; i < 9; i++)
		{
			...
			vector.Normalize();
			vector *= 6f;
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vector.X, vector.Y, Mod.Find<ModProjectile>("DreadTooth").Type, 30, 1f, Main.myPlayer, 0f, 0f);
		}
	}
