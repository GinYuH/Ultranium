...
public class DreadOrbiter : ModNPC
{
	...
	public override void AI()
	{
		...
		if (ShootTimer >= 60)
		{
			...
			Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center.X, NPC.Center.Y, (float)(Math.Cos(num6) * (double)num4 * -1.0), (float)(Math.Sin(num6) * (double)num4 * -1.0), num5, num3, 0f, Main.myPlayer, 0f, 0f);
		}
	}
}
