...
public class UltrumTelegraph : ModProjectile
{
	...
	public override void AI()
	{
		...
		{
			Projectile obj = Main.projectile[Projectile.NewProjectile(((ModProjectile)this).Projectile.Center.X, ((ModProjectile)this).Projectile.Center.Y, 0f, -24f, ((ModProjectile)this).Mod.Find<ModProjectile>("UltraniumBlast").Type, 45, 0f, Main.myPlayer, 0f, 40f)];
			obj.localAI[1] = 125f;
