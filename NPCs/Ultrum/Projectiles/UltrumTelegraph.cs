...
public class UltrumTelegraph : ModProjectile
{
	...
	public override void AI()
	{
		...
		{
			Projectile obj = Main.projectile[Projectile.NewProjectile(((ModProjectile)this).projectile.Center.X, ((ModProjectile)this).projectile.Center.Y, 0f, -24f, ((ModProjectile)this).mod.ProjectileType("UltraniumBlast"), 45, 0f, Main.myPlayer, 0f, 40f)];
			obj.localAI[1] = 125f;
	...
	{
		Main.spriteBatch.Draw(Main.magicPixel, ((ModProjectile)this).projectile.position - new Vector2(3f, 4000f) - Main.screenPosition, null, new Color(0, 120, 45) * (1f - (float)((ModProjectile)this).projectile.alpha / 255f), ((ModProjectile)this).projectile.rotation, Vector2.Zero, new Vector2(6f, 4f), SpriteEffects.None, 0f);
		return false;
	}
}
