...
public class EtherealLaserRift : ModProjectile
{
	public override void SetStaticDefaults()
	{
		// ((ModProjectile)this).DisplayName.SetDefault("Ethereal Portal");
	}
	...
	public override void AI()
	{
		...
		Vector2 spinningpoint = new Vector2(-20f, -20f);
		float num = 1f;
		((ModProjectile)this).Projectile.ai[0] += 2f;
		float num2 = ((ModProjectile)this).Projectile.ai[0] / num;
		if (((ModProjectile)this).Projectile.ai[0] % 60f == 0f)
		{
			SoundEngine.PlaySound(SoundID.Item117, ((ModProjectile)this).Projectile.position);
			float num3 = 2f;
