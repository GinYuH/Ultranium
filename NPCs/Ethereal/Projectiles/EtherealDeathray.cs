...
public class EtherealDeathray : ModProjectile
{
	...
	{
		// ((ModProjectile)this).DisplayName.SetDefault("Ethereal Death Ray");
	}
	...
	public override void AI()
	{
		...
		((ModProjectile)this).Projectile.ai[1] += 3.5f * multiplier;
	...
	public override bool PreDraw(ref Color lightColor)
	{
		...
		Texture2D texture = ((ModProjectile)this).Mod.GetTexture("NPCs/Ethereal/Projectiles/EtherealDeathrayBottom");
		Texture2D texture2D = TextureAssets.Projectile[((ModProjectile)this).Projectile.type].Value;
		Texture2D texture2 = ((ModProjectile)this).Mod.GetTexture("NPCs/Ethereal/Projectiles/EtherealDeathrayTop");
