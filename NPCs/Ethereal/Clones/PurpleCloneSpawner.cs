...
public class PurpleCloneSpawner : ModProjectile
{
	...
	public override void AI()
	{
		...
		if (ScaleTimer == 280)
		{
			NPC.NewNPC((int)((ModProjectile)this).projectile.Center.X, (int)((ModProjectile)this).projectile.Center.Y, ((ModProjectile)this).mod.NPCType("XenanisClone1"), 0, 0f, 0f, 0f, 0f, 255);
		}
	}
}
