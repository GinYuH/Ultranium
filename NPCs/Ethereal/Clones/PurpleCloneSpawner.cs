...
public class PurpleCloneSpawner : ModProjectile
{
	...
	public override void AI()
	{
		...
		if (ScaleTimer == 280)
		{
			NPC.NewNPC((int)((ModProjectile)this).Projectile.Center.X, (int)((ModProjectile)this).Projectile.Center.Y, ((ModProjectile)this).Mod.Find<ModNPC>("XenanisClone1").Type, 0, 0f, 0f, 0f, 0f, 255);
		}
	}
}
