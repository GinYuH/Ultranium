...
public class PurpleCloneSpawner : ModProjectile
{
	...
	{
		// ((ModProjectile)this).DisplayName.SetDefault("Ethereal Rift");
	}
	...
	public override void SetDefaults()
	{
		...
		((ModProjectile)this).Projectile.timeLeft = 320;
	}
	...
	public override bool PreDraw(ref Color lightColor)
	{
		...
		Color value = new Color(137, 131, 255, 127);
		Color color = new Color(119, 222, 216, 127);
		float num8 = num2 % 60f;
		if (num8 < 30f)
		{
	...
	public override void AI()
	{
		...
		if (ScaleTimer == 280)
		{
			NPC.NewNPC(null, (int)((ModProjectile)this).Projectile.Center.X, (int)((ModProjectile)this).Projectile.Center.Y, ((ModProjectile)this).Mod.Find<ModNPC>("XenanisClone1").Type, 0, 0f, 0f, 0f, 0f, 255);
		}
	}
}
