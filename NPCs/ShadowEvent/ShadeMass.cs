...
public class ShadeMass : ModNPC
{
	...
	public override void HitEffect(NPC.HitInfo hit)
    {
        if (NPC.life > 0 || Main.dedServ)
            return;
        Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("ShadeMassGore1").Type);
		Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity, Mod.Find<ModGore>("ShadeMassGore2").Type);
	}
