...
public class FlayerTentacleBody : ModProjectile
{
	public override void SetStaticDefaults()
	{
		((ModProjectile)this).DisplayName.SetDefault("Flayer Tentacle");
	}
	...
	public override void AI()
	{
		...
		if (((ModProjectile)this).projectile.ai[0] == 0f)
		{
			...
			if (Main.myPlayer == ((ModProjectile)this).projectile.owner)
			{
				...
				float num2 = 1f;
				if (((ModProjectile)this).projectile.ai[1] >= 40f + (float)Main.rand.Next(0, 6))
				{
					num = ((ModProjectile)this).mod.ProjectileType("FlayerTentacleTop");
					num2 = 1.4f;
				}
