	...
	public override void AI()
	{
		...
		if (ShootTimer == 120 || ShootTimer == 240)
		{
			...
			for (int j = 0; j < 10; j++)
			{
				...
				vector5.Normalize();
				vector5 *= 6f;
				Projectile.NewProjectile(((ModProjectile)this).projectile.Center.X, ((ModProjectile)this).projectile.Center.Y, vector5.X, vector5.Y, ((ModProjectile)this).mod.ProjectileType("EldritchBlast"), 50, 1f, Main.myPlayer, 0f, 0f);
			}
		}
	}
}
