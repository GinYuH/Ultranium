...
public class MindFlayerSpawner : ModProjectile
{
	...
	public override void AI()
	{
		...
		if (SpawnTimer == 280)
		{
			NPC.NewNPC((int)((ModProjectile)this).projectile.Center.X, (int)((ModProjectile)this).projectile.Center.Y + 100, ((ModProjectile)this).mod.NPCType("MindFlayer"), 0, 0f, 0f, 0f, 0f, 255);
		}
	}
}
