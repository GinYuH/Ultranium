...
public class CosmicBlastSpiral : ModProjectile
{
	...
	public override string Texture => "Ultranium/NPCs/Aldin/Projectiles/CosmicBlast";
	...
	public override void AI()
	{
		...
		if (((ModProjectile)this).Projectile.localAI[0] <= 120f)
		{
