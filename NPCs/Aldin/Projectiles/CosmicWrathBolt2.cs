		...
		if (Main.netMode != 1)
		{
			for (int i = -1; i <= 1; i++)
			{
				if (i != 0)
				{
					...
					Projectile.NewProjectile(null, center, Vector2.UnitY * -18f, ((ModProjectile)this).Mod.Find<ModProjectile>("CosmosBolt").Type, ((ModProjectile)this).Projectile.damage, 0f, Main.myPlayer, 210f, 0f);
				}
			}
		}
