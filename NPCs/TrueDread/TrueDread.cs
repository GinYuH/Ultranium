...
public class TrueDread : ModNPC
{
	...
	public override void SetDefaults()
	{
		...
		base.bossBag/* tModPorter Note: Removed. Spawn the treasure bag alongside other loot via npcLoot.Add(ItemDropRule.BossBag(type)) */ = ((ModNPC)this).Mod.Find<ModItem>("TrueDreadBag").Type;
	...
	public override void AI()
	{
		...
		if (!Circling)
		{
			...
			if (timer == 1)
			{
				SoundEngine.PlaySound(((ModNPC)this).Mod.GetLegacySoundSlot((SoundType)50, "Sounds/DreadRoar")?.WithVolume(1f), -1, -1);
			}
			if (timer < 180)
			{
			...
			{
				Projectile.NewProjectile(((ModNPC)this).NPC.Center.X, ((ModNPC)this).NPC.Center.Y, 0f, 0f, ((ModNPC)this).Mod.Find<ModProjectile>("DreadScythe").Type, num4, 1f, Main.myPlayer, 0f, 0f);
			}
			if (timer > 480 && timer < 820)
			{
				...
				for (int j = 0; j < num6; j++)
				{
					...
					Projectile.NewProjectile(((ModNPC)this).NPC.Center.X, ((ModNPC)this).NPC.Center.Y, vector6.X + num7, vector6.Y + num8, ((ModNPC)this).Mod.Find<ModProjectile>("DreadFlames").Type, num4, 1f, Main.myPlayer, 0f, 0f);
			...
			if (timer == 940 || timer == 1000 || timer == 1060)
			{
				...
				for (int k = 0; k < num9; k++)
				{
					...
					Projectile.NewProjectile(((ModNPC)this).NPC.Center.X, ((ModNPC)this).NPC.Center.Y, num10, num11, ((ModNPC)this).Mod.Find<ModProjectile>("DreadSpit").Type, num4, 1f, ((ModNPC)this).NPC.target, 0f, 0f);
				}
			}
			...
			if (AttackType == 1)
			{
				...
				{
					SoundEngine.PlaySound(((ModNPC)this).Mod.GetLegacySoundSlot((SoundType)50, "Sounds/DreadRay")?.WithVolume(70f), -1, -1);
					float num14 = 10f;
					float num15 = (float)Math.Atan2(((ModNPC)this).NPC.Center.Y - player.Center.Y, ((ModNPC)this).NPC.Center.X - player.Center.X);
					_ = Main.projectile[Projectile.NewProjectile(((ModNPC)this).NPC.Center.X, ((ModNPC)this).NPC.Center.Y, (float)(Math.Cos(num15) * (double)num14 * -1.0), (float)(Math.Sin(num15) * (double)num14 * -1.0), ((ModNPC)this).Mod.Find<ModProjectile>("DreadRay").Type, num4 + 10, 0f, 0, 0f, 0f)];
				}
				if (timer == 1360)
				{
					timer = 1500;
			...
			if (AttackType == 2)
			{
				...
				{
					float num16 = 5f;
					int num17 = ((ModNPC)this).Mod.Find<ModProjectile>("GiantDreadOrb").Type;
					SoundEngine.PlaySound(SoundID.Item20, new Vector2(((ModNPC)this).NPC.position.X, ((ModNPC)this).NPC.position.Y));
					num = (float)Math.Atan2(((ModNPC)this).NPC.Center.Y - player.Center.Y, ((ModNPC)this).NPC.Center.X - player.Center.X);
			...
			{
				float num18 = 8.5f;
				int num19 = ((ModNPC)this).Mod.Find<ModProjectile>("BigToothBall").Type;
			...
			if (timer > 1860 && timer < 1960)
			{
				...
				{
					float num20 = 15f;
					int num21 = ((ModNPC)this).Mod.Find<ModProjectile>("TrueDreadOrbiterBolt").Type;
					SoundEngine.PlaySound(SoundID.NPCDeath13, ((ModNPC)this).NPC.position);
					num = (float)Math.Atan2(((ModNPC)this).NPC.Center.Y - player.Center.Y, ((ModNPC)this).NPC.Center.X - player.Center.X);
			...
			if (timer > 2025 && timer < 2125)
			{
				...
				{
					float num22 = 15f;
					int num23 = ((ModNPC)this).Mod.Find<ModProjectile>("TrueDreadOrbiterBolt").Type;
					SoundEngine.PlaySound(SoundID.NPCDeath13, ((ModNPC)this).NPC.position);
					num = (float)Math.Atan2(((ModNPC)this).NPC.Center.Y - player.Center.Y, ((ModNPC)this).NPC.Center.X - player.Center.X);
			...
			if (timer == 2190 || timer == 2250 || timer == 2310)
			{
				...
				{
					int num26 = 360 / num25;
					NPC.NewNPC((int)((ModNPC)this).NPC.Center.X, (int)((ModNPC)this).NPC.Center.Y, ((ModNPC)this).Mod.Find<ModNPC>("TrueDreadOrbiter").Type, ((ModNPC)this).NPC.whoAmI, (float)(m * num26), (float)((ModNPC)this).NPC.whoAmI, 0f, 0f, 255);
				}
			}
			...
			if (AttackType2 == 0)
			{
				...
				if (timer == 2490 || timer == 2550 || timer == 2610 || timer == 2670 || timer == 2730)
				{
					...
					for (int n = 0; n < 10; n++)
					{
						...
						Projectile.NewProjectile(((ModNPC)this).NPC.Center, vector10, ((ModNPC)this).Mod.Find<ModProjectile>("DreadScythe").Type, num4, 0f, Main.myPlayer, 0f, 0f);
					}
				}
				if (timer >= 2830)
				{
			...
			if (AttackType2 == 1)
			{
				...
				if (timer == 2490 || timer == 2550 || timer == 2610)
				{
					...
					for (int num31 = 0; (float)num31 < num28; num31++)
					{
						...
						Projectile.NewProjectile(((ModNPC)this).NPC.Center.X, ((ModNPC)this).NPC.Center.Y, vector11.X, vector11.Y, ((ModNPC)this).Mod.Find<ModProjectile>("DreadRay").Type, num4, 2f, Main.myPlayer, (float)num30, 0f);
					}
				}
				if (timer >= 2670)
				{
	...
	public override void OnKill()
	{
		if (Main.bloodMoon)
		{
			Item.NewItem((int)((ModNPC)this).NPC.position.X, (int)((ModNPC)this).NPC.position.Y, ((ModNPC)this).NPC.width, ((ModNPC)this).NPC.height, ((ModNPC)this).Mod.Find<ModItem>("ExistentialDread").Type, 1, false, 0, false, false);
		...
		else
		{
			...
			if (num == 0)
			{
				Item.NewItem((int)((ModNPC)this).NPC.position.X, (int)((ModNPC)this).NPC.position.Y, ((ModNPC)this).NPC.width, ((ModNPC)this).NPC.height, ((ModNPC)this).Mod.Find<ModItem>("DreadSpear").Type, 1, false, 0, false, false);
			}
			if (num == 1)
			{
				Item.NewItem((int)((ModNPC)this).NPC.position.X, (int)((ModNPC)this).NPC.position.Y, ((ModNPC)this).NPC.width, ((ModNPC)this).NPC.height, ((ModNPC)this).Mod.Find<ModItem>("DreadYoyo").Type, 1, false, 0, false, false);
			}
			if (num == 2)
			{
				Item.NewItem((int)((ModNPC)this).NPC.position.X, (int)((ModNPC)this).NPC.position.Y, ((ModNPC)this).NPC.width, ((ModNPC)this).NPC.height, ((ModNPC)this).Mod.Find<ModItem>("DreadDisc").Type, 1, false, 0, false, false);
			}
			if (num == 3)
			{
				Item.NewItem((int)((ModNPC)this).NPC.position.X, (int)((ModNPC)this).NPC.position.Y, ((ModNPC)this).NPC.width, ((ModNPC)this).NPC.height, ((ModNPC)this).Mod.Find<ModItem>("DreadFlameBlaster").Type, 1, false, 0, false, false);
			}
			if (num == 4)
			{
				Item.NewItem((int)((ModNPC)this).NPC.position.X, (int)((ModNPC)this).NPC.position.Y, ((ModNPC)this).NPC.width, ((ModNPC)this).NPC.height, ((ModNPC)this).Mod.Find<ModItem>("FearStaff").Type, 1, false, 0, false, false);
			}
			if (num == 5)
			{
				Item.NewItem((int)((ModNPC)this).NPC.position.X, (int)((ModNPC)this).NPC.position.Y, ((ModNPC)this).NPC.width, ((ModNPC)this).NPC.height, ((ModNPC)this).Mod.Find<ModItem>("DreadTome").Type, 1, false, 0, false, false);
			}
			if (num == 6)
			{
				Item.NewItem((int)((ModNPC)this).NPC.position.X, (int)((ModNPC)this).NPC.position.Y, ((ModNPC)this).NPC.width, ((ModNPC)this).NPC.height, ((ModNPC)this).Mod.Find<ModItem>("DreadScepter").Type, 1, false, 0, false, false);
			}
			if (Main.rand.Next(8) == 0)
			{
				Item.NewItem(((ModNPC)this).NPC.getRect(), ((ModNPC)this).Mod.Find<ModItem>("DreadBreadItem").Type, 1, false, 0, false, false);
			}
			Item.NewItem(((ModNPC)this).NPC.getRect(), ((ModNPC)this).Mod.Find<ModItem>("NightmareFuel").Type, Main.rand.Next(20, 35), false, 0, false, false);
		}
