...
public class EruptionTelegraph : ModProjectile
{
	...
	public override void AI()
	{
		...
		{
			Projectile obj = Main.projectile[Projectile.NewProjectile(null, ((ModProjectile)this).Projectile.Center.X, ((ModProjectile)this).Projectile.Center.Y, 0f, -30f, ((ModProjectile)this).Mod.Find<ModProjectile>("FlameBlast").Type, 55, 0f, Main.myPlayer, 0f, 40f)];
			obj.localAI[1] = 125f;
