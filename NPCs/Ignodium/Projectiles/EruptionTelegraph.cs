...
public class EruptionTelegraph : ModProjectile
{
	...
	public override void AI()
	{
		...
		{
			Projectile obj = Main.projectile[Projectile.NewProjectile(((ModProjectile)this).projectile.Center.X, ((ModProjectile)this).projectile.Center.Y, 0f, -30f, ((ModProjectile)this).mod.ProjectileType("FlameBlast"), 55, 0f, Main.myPlayer, 0f, 40f)];
			obj.localAI[1] = 125f;
