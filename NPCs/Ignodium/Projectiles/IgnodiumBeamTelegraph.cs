...
public class IgnodiumBeamTelegraph : ModProjectile
{
	...
	public override void AI()
	{
		...
		{
			Projectile obj = Main.projectile[Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, -4f, Mod.Find<ModProjectile>("IgnodiumBeam").Type, 55, 0f, Main.myPlayer, 0f, 40f)];
			obj.localAI[1] = 125f;
