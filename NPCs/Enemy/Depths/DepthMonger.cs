...
public class DepthMonger : ModNPC
{
	...
	{
		// ((ModNPC)this).DisplayName.SetDefault("Depth Monger");
		Main.npcFrameCount[((ModNPC)this).NPC.type] = Main.npcFrameCount[461];
	}
	...
	public override void SetDefaults()
	{
		...
		base.BannerItem = ((ModNPC)this).Mod.Find<ModItem>("DepthMongerBanner").Type;
	}
	...
	public override void HitEffect(NPC.HitInfo hit)
	{
		...
		{
			Gore.NewGore(((ModNPC)this).NPC.position, ((ModNPC)this).NPC.velocity, ((ModNPC)this).Mod.GetGoreSlot("Gores/Depths/MongerGore1"));
			Gore.NewGore(((ModNPC)this).NPC.position, ((ModNPC)this).NPC.velocity, ((ModNPC)this).Mod.GetGoreSlot("Gores/Depths/MongerGore2"));
			Gore.NewGore(((ModNPC)this).NPC.position, ((ModNPC)this).NPC.velocity, ((ModNPC)this).Mod.GetGoreSlot("Gores/Depths/MongerGore3"));
		}
	}
